...
function sf(inputValues, name_field) {
  ...
  makeNewButtonOk.onclick = function() {
    ...
    document.write("Hallo, nama saya "+name_field+", saya mempunyai "+inputValues.length+" hobi yaitu " +values.join(", ")+ " dan saya memilih "+selectedOption);
  };
